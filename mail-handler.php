  ...
  <body>
    ...
    <main>
      ...
      <div class="thanks">
        ...
        <p>We will be sure to get back to you as soon as possible! We hope you have a great day! In the meanwhile, check out the rest of our website for artsy ideas or artworks from Mary herself!</p>
        <div class="link-list">
          <div class="link">
      ...
      <?php 
        ...
        $to = "maryfrazier@hughes.net"; // this is your Email address
    ...
    <p>&copy; 2017 Schaffer Industries</p>
  </footer>
</body>
</html>